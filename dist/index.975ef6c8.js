...
var _hospitalDataJs = require("./hospitalData.js");
var _stylesCss = require("./styles.css");
document.addEventListener("DOMContentLoaded", ()=>{
    const loginSection = document.getElementById("loginSection");
    const announcementSection = document.getElementById("announcementSection");
    // Check if user is already logged in
    if (sessionStorage.getItem("isLoggedIn")) showAnnouncementSystem();
    ...
    loginForm.addEventListener("submit", (e)=>{
        ...
        } else errorElement.textContent = "Invalid username or password";
    });
    ...
    function initializeAnnouncementSystem() {
        ...
        (0, _hospitalDataJs.hospitalData).codes.forEach((code)=>{
            const btn = document.createElement("button");
            btn.className = "announcement-btn";
            btn.dataset.codeId = code.id;
            btn.innerHTML = `${code.name}<span class="checkmark">\u{2713}</span>`;
            btn.style.backgroundColor = code.color;
            btn.style.color = (0, _hospitalDataJs.getContrastColor)(code.color);
        ...
        (0, _hospitalDataJs.hospitalData).floors.forEach((floor)=>{
            const option = new Option(floor.name, floor.id);
            floorSelect.add(option);
        });
        // Populate rooms
        const roomSelect = document.getElementById("roomSelect");
        (0, _hospitalDataJs.hospitalData).rooms.forEach((room)=>{
...
generateBtn.addEventListener("click", async ()=>{
    ...
    try {
        ...
        if (!speechResult) console.error("Failed to generate speech");
    } catch (error) {
...
},{"./hospitalData.js":"7CioW","./styles.css":"lW6qc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7CioW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hospitalData", ()=>hospitalData);
parcelHelpers.export(exports, "getContrastColor", ()=>getContrastColor);
const hospitalData = {
    codes: [
        {
            id: 1,
